...
class ModelArguments(QuantizationArguments, ProcessorArguments, ExportArguments, VllmArguments):
    ...
    prm_device_map: Optional[str] = field(
        default="auto",
        metadata={"help": "Device map for model placement, derived from training stage. Do not specify it."},
    )
    ...
    prm_model: Optional[str] = field(
        default=None,
        metadata={"help": "prm_model"},
    )
    prm_model_type: Literal["default", "qwen_math_prm"] = field(
        default="default",
        metadata={"help": "Model type for PRM model ('default', 'qwen_math_prm')."},
    )
    remote_work_dir: Optional[str] = field(
        default=None,
        metadata={"help": "moxing to remote_work_dir"},
    )
